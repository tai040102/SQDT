...
class DETRHOI(nn.Module):
    ...
    def forward(self, samples: NestedTensor):
        ...
        hs, memory = self.transformer(self.input_proj(src), mask, ins_query_embed, pos[-1], check_hoi = False)
        ...
        #attention_scores = torch.matmul(h_hs, o_hs.transpose(-2, -1))
        #attention_weights = F.softmax(attention_scores, dim=-1)

        #ins_guided_embed = torch.matmul(attention_weights, o_hs)
